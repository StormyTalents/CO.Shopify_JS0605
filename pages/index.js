...
export async function getStaticProps() {
  ...
  const pageContent = pages.find((idxs) => { return idxs.fields.slug === "home"; })
  const products = await getProdNeeded(pageContent.fields.content.content, allProducts, contenfulData.bannerList)
  ...
  const richTextData = await getRichTextDataNeeded(pageContent.fields.content.content, contenfulData)
