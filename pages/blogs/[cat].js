...
function PostPage({ catPost, currentCat }) {
  ...
  const postToShow = catPost
    .sort((a, b) => (a.fields.publishDate < b.fields.publishDate ? 1 : -1))
    .slice(0, 6);
  ...
  return (
    <div className="post--cat--page reco--section">
      <SEO
        title={
          currentCat.fields.metaTitleTag
            ? currentCat.fields.metaTitleTag
            : `${currentCat.fields.title} - AFTCO`
        }
        description={
          currentCat.fields.metaDescription
            ? currentCat.fields.metaDescription
            : null
        }
      />

      {currentCat.fields.heroBanner && (
        <HeroBanner hero={currentCat.fields.heroBanner.fields} />
      )}
            ...
            <div className="reco--item full grid--child mb-50">
              <div className="post--img--wrap">
                {post.fields.contentFromShogun ? (
                  <a href={postPage} className="shogun">
                    {post.fields.thumbnail ? (
                      <Image
                        src={
                          post.fields.thumbnail && post.fields.thumbnail.fields
                            ? "https:" + post.fields.thumbnail.fields.file.url
                            : "/icons/logo.png"
                        }
                        width={
                          post.fields.thumbnail && post.fields.thumbnail.fields
                            ? post.fields.thumbnail.fields.file.details.image
                                .width
                            : 500
                        }
                        height={
                      ...
                      <Image
                        src={
                          post.fields.heroImage && post.fields.heroImage.fields
                            ? "https:" + post.fields.heroImage.fields.file.url
                            : "/icons/logo.png"
                        }
                        width={
                          post.fields.heroImage && post.fields.heroImage.fields
                            ? post.fields.heroImage.fields.file.details.image
                                .width
                            : 500
                        }
                        height={
                ...
                <div className="post--caption">
                  ...
                  {post.fields.contentFromShogun ? (
                    <a href={postPage} className="shogun">
                      <h2 className="cl-b h4">{post.fields.title}</h2>
                    </a>
                  ) : (
                    <Link href={postPage}>
                      <a>
                  ...
                  {post.fields.shortDescription ? (
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: post.fields.shortDescription,
                      }}
                    />
                  ) : (
                    post.fields.body && (
                      <div className="short--desc">
                        <p>{bodyext(post.fields.body)}...</p>
                      </div>
                    )
                  )}
                  {post.fields.contentFromShogun ? (
                    <a href={postPage} className="button small mt-20 shogun">
                      Read More
                    </a>
                  ) : (
                    <Link href={postPage}>
                      <a className="button small mt-20">Read More</a>
                    </Link>
                  )}
                </div>
              </div>
